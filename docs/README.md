...
- [MULTICORE_PARALLELIZATION.md](MULTICORE_PARALLELIZATION.md) - 多核并行实现
  ...
  - 实现策略
  - 性能测试结果
- [PERFORMANCE_ANALYSIS_200_SAMPLES.md](PERFORMANCE_ANALYSIS_200_SAMPLES.md) - 大规模数据集性能分析

### 🖥️ 桌面应用部署

**构建独立可执行文件:**
1. [DESKTOP_APP_GUIDE.md](DESKTOP_APP_GUIDE.md) - 桌面应用使用指南
2. [DESKTOP_APP_FEASIBILITY.md](DESKTOP_APP_FEASIBILITY.md) - 桌面应用可行性分析
3. [NUITKA_BUILD_GUIDE.md](NUITKA_BUILD_GUIDE.md) - Nuitka 编译完整指南
4. [DESKTOP_PACKAGING_STATUS.md](DESKTOP_PACKAGING_STATUS.md) - 当前打包状态
...
- [UPDATES-121225.md](UPDATES-121225.md) - 12月更新汇总
- [CONSOLIDATED_UPDATES.md](CONSOLIDATED_UPDATES.md) - 合并更新记录

#### 待办事项 (可能过时)
- [TODO_CONCENTRATION_PERSISTENCE.md](TODO_CONCENTRATION_PERSISTENCE.md) - 浓度持久化待办
- [TODO_FD_BUGS.md](TODO_FD_BUGS.md) - 一阶导数法 Bug 列表
- [TODO_FD_IMPROVEMENT.md](TODO_FD_IMPROVEMENT.md) - 一阶导数法改进计划
- [BUGFIX_TODO.md](BUGFIX_TODO.md) - Bug 修复待办
...
- [PERFORMANCE_ANALYSIS_200_SAMPLES.md](PERFORMANCE_ANALYSIS_200_SAMPLES.md)

### 部署相关
- [DESKTOP_APP_GUIDE.md](DESKTOP_APP_GUIDE.md)
- [NUITKA_BUILD_GUIDE.md](NUITKA_BUILD_GUIDE.md)
- [DESKTOP_PACKAGING_STATUS.md](DESKTOP_PACKAGING_STATUS.md)
...
| 构建桌面应用 | [NUITKA_BUILD_GUIDE.md](NUITKA_BUILD_GUIDE.md) |
